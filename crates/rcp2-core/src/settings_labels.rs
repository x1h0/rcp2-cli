...
#[cfg(test)]
mod tests {
    use super::{TIMEZONES, language_label, timezone_label};

    #[test]
    fn timezone_table_is_complete() {
        assert_eq!(TIMEZONES.len(), 137);
    }

    #[test]
    fn timezone_label_maps_known_index() {
        assert_eq!(
            timezone_label(49),
            "(UTC+01:00) Amsterdam, Berlin, Bern, Rome, Stockholm, Vienna"
        );
    ...
    #[test]
    fn timezone_label_falls_back_for_out_of_range() {
        assert_eq!(timezone_label(500), "#500");
    }

    #[test]
    fn language_label_maps_known_and_unknown() {
